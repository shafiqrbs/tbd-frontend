...
export default function Login() {
    ...
    return (
        <Box component='form' className={LoginPage.wrapper} h={height}
            ...
            <Paper className={LoginPage.form} radius={0} p={10} h={height} ml={`auto`} maw={350}>
                ...
                >
                    <TextInput withAsterisk label="Email" placeholder="Email"
                               size='xs' {...form.getInputProps('email')} />
                ...
                <Tooltip
                    ...
                    transitionProps={{transition: 'pop-bottom-left', duration: 500}}
                >
                    <PasswordInput withAsterisk label="Password" placeholder="Your password" mt="md"
                                   size="xs" {...form.getInputProps('password')} />
