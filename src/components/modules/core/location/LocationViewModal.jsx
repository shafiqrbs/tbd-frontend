...
function LocationViewModal(props) {
    ...
    const CloseModal = () => {
        props.setLocationViewModal(false);
    }

    return (
        <>
            <Modal
                opened={props.locationViewModal}
                onClose={CloseModal}
            ...
            >
                <Box m={'md'}>
                    <Grid columns={24}>
                        <Grid.Col span={'6'} align={'left'} fw={'600'} fz={'14'}>{t('LocationType')}</Grid.Col>
                        <Grid.Col span={'1'}>:</Grid.Col>
                        <Grid.Col span={'auto'}>{entityEditData && entityEditData.category_group && entityEditData.category_group}</Grid.Col>
                    </Grid>
                    <Grid columns={24}>
                        <Grid.Col span={'6'} align={'left'} fw={'600'} fz={'14'}>{t('LocationName')}</Grid.Col>
                        <Grid.Col span={'1'}>:</Grid.Col>
