...
export default function Navigation(props) {
    ...
    return (
        <>
            <ScrollArea h={module === "voucher-entry" ? height - 4 : height} bg="white" type="never"
                    ...
                    <Flex direction={`column`} align={"center"} mt="xs">
                        ...
                        >
                            <Button
                                ...
                                radius="xl"
                                onClick={(e) => {
                                    navigate("/accounting/branch/entry");
                                }}
                            >
                                <Flex direction={`column`} align={"center"}>
                                    <IconCategory size={16} color={"white"}/>
                    ...
                    <Flex direction={`column`} align={"center"}>
                        ...
                        >
                            <Button
                                ...
                                radius="xl"
                                onClick={(e) => {
                                    navigate("/accounting/branch/voucher-entry");
                                }}
                            >
                                <Flex direction={`column`} align={"center"}>
                                    <IconDashboard size={16} color={"white"}/>
