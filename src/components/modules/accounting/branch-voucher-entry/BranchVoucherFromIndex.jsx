...
import BranchVoucherNavigation from "./BranchVoucherNavigation.jsx";
import BranchCustomerVoucherForm from "./voucher-forms/BranchCustomerVoucherForm.jsx";
...
function BranchVoucherFromIndex({currencySymbol}) {
    ...
    const updateLocalStorageAndResetForm = (products, type) => {
        localStorage.setItem("temp-branch-voucher-entry", JSON.stringify(products));
        loadMyItemsFromStorage();
    ...
    const handleInputChange = (index, field, value) => {
        ...
        localStorage.setItem("temp-branch-voucher-entry", JSON.stringify(updatedItems));
    };
    ...
    const renderForm = () => {
        return (<BranchCustomerVoucherForm
    ...
    const form = useForm({
        initialValues: {
            ref_no: "", issue_date: new Date(), description: "", branch_id: ""
        }, validate: {
            issue_date: (value) => value ? null : "Please select date",
            branch_id: (value) => value ? null : "Please select branch",
        },
    });
                        ...
                        >
                            ...
                            <Grid columns={18} gutter={{base: 2}}>
                                ...
                                <Grid.Col span={6}>
                                    <Text ta="left" size="sm">
                                        {" "}
                                        {currencySymbol} {primaryLedgerHeadObject?.show_amount && primaryLedgerHeadObject?.amount}
                                    </Text>
                                </Grid.Col>
                                <Grid.Col span={3} mt={2}>
                                    <Text ta="left" size="xs" pl={"md"}>
...
export default BranchVoucherFromIndex;
