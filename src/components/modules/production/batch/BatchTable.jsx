...
import {IconDotsVertical, IconFilePencil, IconTrashX, IconCheckbox} from '@tabler/icons-react'
                        ...
                        },
                        {
                            ...
                            render: (item) => (
                                <Group gap={4} justify="right" wrap="nowrap">
                                    <Group gap={4} justify="right" wrap="nowrap">
                                        <Button component="a" size="compact-xs" radius="xs" variant="filled" fw={'100'}
                                                fz={'12'}
                                    ...
                                    <Menu position="bottom-end" offset={3} withArrow trigger="hover" openDelay={100}
                                          closeDelay={400}>
                                        <Menu.Target>
                                            <ActionIcon size="sm" variant="transparent" color='red' radius="sm"
                                                        aria-label="Settings">
