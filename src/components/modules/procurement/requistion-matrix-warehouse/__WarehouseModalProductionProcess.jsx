...
export default function __WarehouseModalProductionProcess({boardId}) {
    ...
    const fetchData = async () => {
        ...
        setFetching(true);
        const value = {
            url: 'inventory/requisition/matrix/board/warehouse/production/' + boardId,
            param: {}
        };
        try {
    ...
    const handleSubmit = async () => {
        ...
        const value = {
            url: 'inventory/requisition/matrix/board/warehouse/production/process',
    ...
    const QuantityInput = ({item, onDemandChange}) => {
        ...
        const handleQuantityUpdateDB = async () => {
            ...
            if (newQuantity !== item.demand_quantity) {
                ...
                const value = {
                    url: 'inventory/requisition/matrix/board/warehouse/production/quantity-update',
    ...
    const handleApprove = async (proBatchId) => {
        const value = {
            url: 'inventory/requisition/matrix/board/warehouse/production/approve/' + proBatchId,
            data: {},
        };
