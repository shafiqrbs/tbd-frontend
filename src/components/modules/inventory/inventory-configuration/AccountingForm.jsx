      ...
      <form onSubmit={form.onSubmit(handleAccountingFormSubmit)}>
        <Box pt={"xs"} >
            ...
            <Box bg="gray.1" px="sm" py="xs" mt="xs">
                <Text fz={14} fw={600}> {t("AccountTransactionHead")}</Text>
            </Box>
            <Box pl="sm">
                  <Box mt={"xs"}>
                    <Grid columns={24} gutter={{ base: 1 }}>
            ...
            <Box bg="gray.1" px="sm" py="xs" mt="xs">
                <Text fz={14} fw={600}> {t("ReceivablePayableHead")}</Text>
            </Box>
            <Box pl="sm">
                <Box mt={"xs"}>
                    <Grid columns={24} gutter={{ base: 1 }}>
            ...
            <Box bg="gray.1" px="sm" py="xs" mt="xs">
                <Text fz={14} fw={600}> {t("Inventory")}</Text>
            </Box>
            <Box pl="sm">
                <Box mt={"xs"}>
                    <Grid columns={24} gutter={{ base: 1 }}>
            ...
            <Box bg="gray.1" px="sm" py="xs" mt="xs">
                <Text fz={14} fw={600}> {t("PurchaseAndSalesLedger")}</Text>
            </Box>
            <Box pl="sm">
                <Box mt={"xs"}>
                    <Grid columns={24} gutter={{ base: 1 }}>
            ...
            <Box bg="gray.1" px="sm" py="xs" mt="xs">
                <Text fz={14} fw={600}> {t("DutiesAndTaxesLedger")}</Text>
            </Box>
            <Box pl="sm">
                <Box mt={"xs"}>
                    <Grid columns={24} gutter={{ base: 1 }}>
