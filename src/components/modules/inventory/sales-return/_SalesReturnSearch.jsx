            ...
            <Grid.Col span={6}>
              ...
              >
                <TextInput
                  ...
                  value={purchaseReturnFilterData.searchKeyword}
                  id={"SearchKeyword"}
                  rightSection={
                    purchaseReturnFilterData.searchKeyword ? (
            ...
            <Grid.Col span={6}>
              ...
              >
                <Select
                  ...
                  clearable
                  searchable
                  value={purchaseReturnFilterData.vendor_id}
                  onChange={(e) => {
                    dispatch(
                      setPurchaseReturnFilterData({
                        ...purchaseReturnFilterData,
            ...
            <Grid.Col span={6}>
              ...
              >
                <DateInput
                  ...
                  value={purchaseReturnFilterData.start_date}
        ...
        <Grid.Col span="auto">
          <ActionIcon.Group mt={"1"}>
            <ActionIcon
              ...
              aria-label="Filter"
              onClick={() => {
                purchaseReturnFilterData.searchKeyword.length > 0 ||
                purchaseReturnFilterData.vendor_id ||
                purchaseReturnFilterData.start_date
