...
export function SalesPrintA4(props) {


    const { salesViewData, setPrintA4 } = props;
                        ...
                        <div className={classes['footer-right-section']}>
                            ...
                            <div className={classes['footer-data-section']}>
                                <div className={classes['invoice-footer-two-right']}>
                                    <p className={classes['invoice-footer-text-two']}>{salesViewData && salesViewData.sub_total && Number(salesViewData.sub_total).toFixed(2)}
                                    </p>
