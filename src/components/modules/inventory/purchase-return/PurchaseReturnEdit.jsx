...
import _PurchaseReturnUpdateForm from "./_PurchaseReturnUpdateForm.jsx";

function PurchaseReturnEdit() {
  let { id } = useParams();
        ...
        <Box>
          {domainConfigData && (
            <>
              ...
              />
              <Box p={"8"}>
                  <_PurchaseReturnUpdateForm domainConfigData={domainConfigData} />
              </Box>
            </>
          )}
        </Box>
