...
export default function _PurchaseReturnUpdateForm() {
    ...
    // Load vendors + purchase return details
    useEffect(() => {
            ...
            try {
                ...
                if (result?.data?.status === 200) {
                    ...
                    if (returnRes?.data?.status === 200) {
                        ...
                        setPurchaseReturnItems(returnData.purchase_return_items.map(it => ({
                            id: it.purchase_item_id,
                            display_name: it.item_name,
                            quantity: it.quantity,
                            purchase_price: it.purchase_price,
                            unit_name: it.uom,
                            sub_total: it.quantity * it.purchase_price
                        })));
                    }
                }
            } catch (err) {
