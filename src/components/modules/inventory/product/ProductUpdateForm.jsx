...
function ProductUpdateForm(props) {
    ...
    const handleSkuFormSubmit = (values) => {
        console.log("Child form sku values:", values);
                        ...
                        <Grid.Col span={8} >
                            <Box bg={'white'} p={'xs'} className={'borderRadiusAll'} >
                                ...
                                <Box pl={`xs`} pr={'xs'} className={'borderRadiusAll'}>
                                    <ScrollArea h={height - 102} scrollbarSize={2} scrollbars="y" type="never">
                                        <Box>
                                ...
                                <Box bg={'white'} p={'xs'} className={'borderRadiusAll'} >
                                                    ...
                                                    <>
                                                        {
                                                            ...
                                                            <Button
                                                                ...
                                                                color={`red.3`}
                                                                onClick={() => {
                                                                    handlemeasurementFormSubmit(measurementForm.values)
                                                                }}
                                                                id="EntityFormSubmit"
                                    ...
                                    <Box pl={`xs`} pr={'xs'} className={'borderRadiusAll'}>
                                        <ScrollArea h={height - 105} scrollbarSize={2} scrollbars="y" type="never">
                                            ...
                                            <Group justify={'space-between'} mb={'xs'} gap={'xs'} grow>
                                        ...
                                        <ScrollArea h={height - 105} scrollbarSize={2} scrollbars="y" type="never">
                                            ...
                                            <Card padding="xs">
                                                <Card.Section p={'xs'}>
                                                    ...
                                                    >
                                                        {featureImage ? (
                                                            <Image src={featureImage} height={178} fit="cover" alt="Feature image" />
                                                        ) : (
                                                            <Center h={178}>
